...
from Kobryn_AQA_course.lesson_25_pony.models.base_model import UserM, CarM
...
class UserRepo:
    ...
    @db_session
    def get_by_id(self, id: int, with_cars=True):
        user = UserM.get(lambda u: u.id == id)
...
if __name__ == '__main__':
    repo = UserRepo()
    print(f"This is user with ID=4 with cars: \n{repo.get_by_id(id=4, with_cars=True)}\n")
